...
def generate(
    ...
    *,
    ...
    tokenizer = torchtune.models.llama3.llama3_tokenizer(path="/is/sg2/xli/.cache/huggingface/hub/models--meta-llama--Llama-3.2-1B-Instruct/snapshots/9213176726f574b556790deb65791e0c5aa438b6/original/tokenizer.model")
    print(tokenizer.decode(generated_tokens[0].tolist(), skip_special_tokens=False))
    ...
    if not padding_masks.all():
        ...
        print("max_generated_tokens", max_generated_tokens)
        print("padding_masks1", padding_masks)
